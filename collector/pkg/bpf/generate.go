...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target amd64 -cc clang stackwalker ruby_stack_walker.c -- -I. -D__TARGET_ARCH_x86 -mcpu=v3
...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target arm64 -cc clang stackwalker ruby_stack_walker.c -- -I. -D__TARGET_ARCH_arm64 -mcpu=v3
