...
func (s *StackWalkerBPF) loadIOTracer() error {
	...
	tracepoints := []tpAttach{
		...
		{"sys_enter_ppoll", ioObjs.TpSysEnterPpoll},
		{"sys_exit_ppoll", ioObjs.TpSysExitPpoll},
		{"sys_enter_poll", ioObjs.TpSysEnterPoll},
		{"sys_exit_poll", ioObjs.TpSysExitPoll},
		{"sys_enter_epoll_wait", ioObjs.TpSysEnterEpollWait},
		{"sys_exit_epoll_wait", ioObjs.TpSysExitEpollWait},
		{"sys_enter_pselect6", ioObjs.TpSysEnterPselect6},
		{"sys_exit_pselect6", ioObjs.TpSysExitPselect6},
		{"sys_enter_accept4", ioObjs.TpSysEnterAccept4},
		{"sys_exit_accept4", ioObjs.TpSysExitAccept4},
		{"sys_enter_futex", ioObjs.TpSysEnterFutex},
		{"sys_exit_futex", ioObjs.TpSysExitFutex},
		{"sys_enter_clone", ioObjs.TpSysEnterClone},
		{"sys_exit_clone", ioObjs.TpSysExitClone},
		{"sys_enter_getrandom", ioObjs.TpSysEnterGetrandom},
		{"sys_exit_getrandom", ioObjs.TpSysExitGetrandom},
		{"sys_enter_clock_gettime", ioObjs.TpSysEnterClockGettime},
		{"sys_exit_clock_gettime", ioObjs.TpSysExitClockGettime},
	}
